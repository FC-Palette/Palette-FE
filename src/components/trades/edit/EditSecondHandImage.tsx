...
import { editSecondHandImage, RemoveSecondHandImage } from 'recoil/index'
...
export const EditSecondHandImage = () => {
  const [showMessage, setShowMessage] = useState(false)
  const [images, setImages] = useState<ImageFile[]>([])
  const [editSecondHandState, setEditSecondHandState] =
    useRecoilState(editSecondHandImage)
  const [removeSecondHandImageState, setRemoveSecondHandImageState] =
    useRecoilState(RemoveSecondHandImage)

  console.log(images)
  console.log(editSecondHandState)
  console.log(removeSecondHandImageState)
  ...
  const handleImageUpload = (acceptedFiles: File[]) => {
    ...
    acceptedFiles.forEach(file => {
      encodeImageToBlob(file, blob => {
        ...
        setEditSecondHandState((prevData: any) => ({
          ...prevData,
  ...
  const handleImageDelete = (imageId: string) => {
    ...
    if (removedImage && removedImage.url) {
      ...
      setRemoveSecondHandImageState(prevData => {
        return {
          ...prevData,
